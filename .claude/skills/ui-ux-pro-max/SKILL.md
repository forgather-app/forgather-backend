...
- `z-index-management` - Define z-index scale (10, 20, 30, 40, 50)
...
| **Stable hover states** | Use color/opacity transitions on hover | Change width/height/margin on hover (causes layout shift) |
